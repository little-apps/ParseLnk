...
namespace ParseLnk.Interop
{
    public static class Structs
    {
        ...
        public struct ShellLinkHeader
        {
            ...
            /// <summary>
            /// A <see cref="FILETIME"/> structure that specifies the creation time of the link target in UTC (Coordinated Universal Time). If the value is zero, there is no creation time set on the link target.
            /// </summary>
            public FILETIME CreationTime;
            /// <summary>
            /// A <see cref="FILETIME"/> structure that specifies the access time of the link target in UTC (Coordinated Universal Time). If the value is zero, there is no access time set on the link target.
            /// </summary>
            public FILETIME AccessTime;
            /// <summary>
            /// A <see cref="FILETIME"/> structure that specifies the write time of the link target in UTC (Coordinated Universal Time). If the value is zero, there is no write time set on the link target.
            /// </summary>
            ...
            /// <summary>
            /// A 32-bit unsigned integer that specifies the expected window state of an application launched by the link. This value should be one of <see cref="Enums.ShowWindowCommands"/>
            /// </summary>
            public Enums.ShowWindowCommands ShowCommand;
            /// <summary>
            /// A <see cref="HotKeyFlags"/> structure that specifies the keystrokes used to launch the application referenced by the shortcut key. This value is assigned to the application after it is launched, so that pressing the key activates that application.
            /// </summary>
        ...
        /// <summary>
        /// The LinkTargetIDList structure specifies the target of the link. The presence of this optional structure is specified by the HasLinkTargetIDList bit in <see cref="Enums.LinkFlags"/> in the <see cref="ShellLinkHeader"/>.
        /// </summary>
        ...
        /// <summary>
        /// An ItemID is an element in an <see cref="IDList"/> structure. The data stored in a given ItemID is defined by the source that corresponds to the location in the target namespace of the preceding ItemIDs. This data uniquely identifies the items in that part of the namespace.
        /// </summary>
        public struct ItemID
        {
            /// <summary>
            /// A 16-bit, unsigned integer that specifies the size, in bytes, of the ItemID structure, including the ItemIDSize field.
            /// </summary>
            public ushort Size;
            /// <summary>
        ...
        /// <summary>
        /// StringData refers to a set of structures that convey user interface and path identification information. The presence of these optional structures is controlled by <see cref="Enums.LinkFlags"/> in the <see cref="ShellLinkHeader"/>.
        /// </summary>
        ...
        public struct LinkInfo
        {
            ...
            /// <summary>
            /// An optional <see cref="LinkInfoVolumeId"/> structure that specifies information about the
            /// volume that the link target was on when the link was created. This field is present
            /// if the VolumeIDAndLocalBasePath flag is set in <see cref="Enums.LinkInfoFlags"/>.
            /// </summary>
        ...
        /// appended to the basic Shell Link Binary File Format.
        /// These are the first two fields for each extra data block.
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct ExtraDataHeader
        {
            ...
            public uint Size;
            /// <summary>
            /// A 32-bit, unsigned integer that specifies the signature of the each extra data section.
            /// See <seealso cref="ParseLnk.ExtraData.Blocks"/> for the signatures for each extra data section.
            /// </summary>
        ...
        {
            /// <summary>
            /// A 16-bit, unsigned integer that specifies the <see cref="FillAttributes"/> attributes that control the foreground and background text colors in the console window.
            /// </summary>
            public Enums.FillAttributes FillAttributes;
            /// <summary>
            /// A 16-bit, unsigned integer that specifies the <see cref="FillAttributes"/> that control the foreground and background text color in the console window popup. The values are the same as for the FillAttributes field.
            /// </summary>
            ...
            public int Unused2;
            /// <summary>
            /// A 32-bit, unsigned integer that specifies the size, in pixels, of the font used in the console window.
            /// </summary>
            public uint FontSize;
            /// <summary>
            /// A 32-bit, unsigned integer that specifies the family of the font used in the console window. This value MUST be one of the following in <see cref="Enums.FontFamily"/>
            /// </summary>
            public Enums.FontFamily FontFamily;
            /// <summary>
            /// A 16-bit, unsigned integer that specifies the stroke weight of the font used in the console window.
            /// If the value is equal to or greater than 700, it is bold. Anything less than 700, 
            /// </summary>
            ...
            /// A value less than or equal represents a small cursor.
            /// A value between 26 and 50 represents a medium cursor.
            /// A value between 51 and 100 represents a large cursor.
            /// </summary>
            ...
            /// If false, the values of the WindowOriginX and WindowOriginY fields are used to position the console window. 
            /// </summary>
            [MarshalAs(UnmanagedType.Bool)]
        ...
        public struct KnownFolderDataBlock
        {
            ...
            /// <summary>
            /// A 32-bit, unsigned integer that specifies the location of the <see cref="ItemID"/> of the first child segment of the <see cref="IDList"/> specified by KnownFolderID. This value is the offset, in bytes, into the link target IDList.
            /// </summary>
            public uint Offset;
        }
        ...
        /// <summary>
        /// The SpecialFolderDataBlock structure specifies the location of a special folder. This data can be used when a link target is a special folder to keep track of the folder, so that the link target <see cref="IDList"/> can be translated when the link is loaded.
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct SpecialFolderDataBlock
        {
            ...
            /// <summary>
            /// A 32-bit, unsigned integer that specifies the location of the <see cref="ItemID"/> of the first child segment of the <see cref="IDList"/> specified by SpecialFolderID. This value is the offset, in bytes, into the link target IDList.
            /// </summary>
            public uint Offset;
        }
        ...
        public struct TrackerDataBlock
        {
            ...
            public uint Version;
            /// <summary>
            /// A character string, as defined by the system default code page, which specifies the NetBIOS name of the machine where the link target was last known to reside.
            /// </summary>
        ...
        /// <summary>
        /// The VistaAndAboveIDListDataBlock structure specifies an alternate IDList that can be used instead of the <see cref="LinkTargetIDList"/> structure on platforms that support it.
        /// </summary>
